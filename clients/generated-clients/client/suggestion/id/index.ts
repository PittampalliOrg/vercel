...
/**
 * Builds and executes requests for operations under /Suggestion/id
 */
export interface IdRequestBuilder extends BaseRequestBuilder<IdRequestBuilder> {
    /**
     * Gets an item from the Kiota.Suggestion.id.item collection
 ...
 */
export const IdRequestBuilderUriTemplate = "{+baseurl}/Suggestion/id";
/**
