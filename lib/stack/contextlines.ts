import type { Event, IntegrationFn, StackFrame } from "@/lib/stack/types-hoist";
import { GLOBAL_OBJ, addContextToFrame, stripUrlQueryAndFragment } from "@/lib/stack/utils-hoist";
import { defineIntegration } from "@/lib/stack/integration";
